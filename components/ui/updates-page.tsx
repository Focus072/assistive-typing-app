...
export function UpdatesContent() {
  ...
  const updates = [
    ...
    },
    {
      ...
      date: "January 2024",
      category: "Feature",
      title: "Waitlist is now open",
      description: "Join thousands of users on our waitlist to be the first to experience natural typing automation. Early access coming soon.",
      badge: "Feature",
    ...
    },
    {
      ...
      description: "We're preparing to launch our beta program. Selected waitlist members will receive early access to test Typing Is Boring before public release.",
      badge: "Upcoming",
