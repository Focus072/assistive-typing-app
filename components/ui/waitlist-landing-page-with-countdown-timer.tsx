  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black w-full">
      ...
      <div className="relative z-10 min-h-screen">
        ...
        {/* Waitlist Card */}
        <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 pt-24 sm:pt-0 pb-8 sm:pb-0">
          <div className="relative w-full max-w-[560px]">
            <div className="relative backdrop-blur-xl bg-black/60 border border-white/20 rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-12 w-full shadow-2xl mx-auto">
