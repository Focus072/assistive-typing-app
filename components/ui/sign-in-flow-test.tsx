...
type NavSectionId = "manifesto" | "careers" | "discover";
...
export const CanvasRevealEffect = ({
  ...
  return (
    <div className={cn("h-full relative w-full", containerClassName)}>
      ...
      {/* Internal canvas gradient disabled to keep dots high-contrast */}
      {showGradient && null}
    </div>
  );
};
...
function MiniNavbar() {
  ...
  return (
    ...
    >
      ...
      >
        <nav className="flex flex-col itemscenter space-y-4 text-base w-full">
          {navLinksData.map((link) => (
            <a
              key={link.href}
              href={link.href}
...
export const SignInTestPage = ({ className }: SignInPageProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Optional single light vignette; remove this div for pure dot matrix */}
